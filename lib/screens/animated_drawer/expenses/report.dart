...
class _ReportState extends State<Report> {
  ...
  Widget build(BuildContext context) {
    Color color = widget.type == 'Income' ? green : red;

    return Scaffold(
      backgroundColor: Colors.black,
      appBar: BasicAppBar('Report'),
      body: Column(
        children: [
          Padding(
                ...
                if (snapshot.data == null ||
                  ...
                  return Column(
                    children: [
                      ...
                      Text(
                        '${'This year'}: ${format(yearAmount.toDouble())} USD',
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Spacer(),
                                            Text(
                                              '${format(totalAmount.toDouble())} USD',
