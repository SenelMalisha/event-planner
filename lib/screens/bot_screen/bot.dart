    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(color: Colors.teal, blurRadius: 10, spreadRadius: 1,blurStyle: BlurStyle.outer)
          ],
          ...
          children: <Widget>[
            Container(
              decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(color: Colors.black, blurRadius: 15, spreadRadius: 1)
                ],
              ),
